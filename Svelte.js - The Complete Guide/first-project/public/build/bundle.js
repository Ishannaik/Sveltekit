    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-1dhremt");
    			add_location(h1, file$3, 1, 2, 12);
    			attr_dev(header, "class", "svelte-1dhremt");
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file, 31, 0, 994);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const meetups = [
    		...
    		},
    		{
    			...
    			imageUrl: "https://process.fs.teachablecdn.com/ADNupMnWyR7kCWRvm76Laz/resize=width:705/https://file-uploads.teachablecdn.com/65ed3e0e175d4779a639f49621f65ae1/22f982bc56c541e8b487e9b6c230cab3",
    			address: "27th Nerd Road, 32523 New York",
